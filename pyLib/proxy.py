...
IGNORE_TAGS_REGEX = re.compile(br"<[/]?(?:xml|terrain|magic|weather|room|exits|header|prompt|status|song|shout|yell|social|hit|damage|avoid_damage|miss|enemy|familiar|snoop.*?|highlight.*?)>")
